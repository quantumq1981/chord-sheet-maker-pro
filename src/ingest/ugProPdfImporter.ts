...
// Re-export span utilities — canonical source is ugProPdfUtils
export type { TextSpan, TimeSigRecord, KeySigRecord } from './ugProPdfUtils.js';
export { detectTimeSigSpans, detectKeySig } from './ugProPdfUtils.js';
